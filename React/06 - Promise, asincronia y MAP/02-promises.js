...
prestamo()
    .then(response => console.log(response)) // Ejecuto algo cuando la promesa se cumple
    .catch(err => console.log(err)) // Ejecuto esto si la promesa se rechaza
 */

    
// Promesa para la preparacion del mate
    let is_stock = true;
